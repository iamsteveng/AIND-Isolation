...
def main():
    ...
    test_agents = [
                    ...
                    Agent(CustomPlayer(score_fn=custom_score, **CUSTOM_ARGS), "Student_1"),
                    Agent(CustomPlayer(score_fn=custom_score_1, **CUSTOM_ARGS), "Student_2"),
                    Agent(CustomPlayer(score_fn=custom_score_2, **CUSTOM_ARGS), "Student_3")
                ]
